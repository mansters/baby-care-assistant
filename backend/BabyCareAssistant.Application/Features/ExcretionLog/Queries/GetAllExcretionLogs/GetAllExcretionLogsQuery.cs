...
namespace BabyCareAssistant.Application.Features.ExcretionLog.Queries.GetAllExcretionLogs;

public record GetAllExcretionLogsQuery : IRequest<Result<List<ExcretionLogDto>>>;

internal sealed class GetAllExcretionLogsQueryHandler(IExcretionLogRepository excretionLogRepository, IMapper mapper)
